...
<body>
    <div class="container">
        ...
        $shippingCharge = ($totalAmount > 200) ? 0 : 5; // Assuming regular charge is S$10
        ?>
        ...
        <?php if ($totalAmount > 0): ?>
            ...
            <?php endif; ?>
            <p class="total">Delivery Charge: S$<?php echo $shippingCharge; ?></p>
            ...
            ?>
            <p class="total">Total Amount: $<?php echo $totalAmountIncludingAll; ?></p>
...
<?php if ($allowCheckout): ?>
        <?php
            // If shipping charge is 0, redirect to checkout1.php
            $checkoutPage = ($shippingCharge == 0) ? 'checkout1.php' : 'checkout.php';
        ?>
        <a href="<?php echo $checkoutPage; ?>" class="btn btn-success checkout-btn">Checkout</a>
    <?php endif; ?>

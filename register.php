...
<div class="container text-center" style="margin:auto; padding-top: 100px;">
    <div class="row justify-content-center">
        <div class="col-md-5 mb-2">
            <a href="login.php"><button class="btn btn-primary btn-block" style="background-color: #C7B7A3; width: calc(50% - 10px);">Login</button></a>
        </div>
        <div class="col-md-5 mb-2">
            <a href="register.php"><button class="btn btn-primary btn-block" style="background-color: white; color: black; width: calc(50% - 10px);">Register</button></a>
        </div>
    </div>
</div>

...
$PayPalApiUsername 	= 'sb-wqsmg29246340_api1.business.example.com'; 		
$PayPalApiPassword 	= 'PRVXS8ZRGNFGLXH4'; 		//Paypal API password
$PayPalApiSignature = 'ApRUeioe73Onh6wFz4HuRQR29JqaA30pQtqNwNdOFsbesTHa0q-VfHck'; 		//Paypal API Signature
$PayPalCurrencyCode = 'SGD'; //Paypal Currency Code
//URL to redirect to after PayPal has complete the online payment
$PayPalReturnURL 	= 'http://localhost:8081/ECAD-Gift-Shop-1/orderConfirmed.php'; 
//URL to redirect to if user clicks cancel                
$PayPalCancelURL 	= 'http://localhost:8081/ECAD-Gift-Shop-1/shopping_cart.php'; 

...
if ($_POST) // Post Data received from the Shopping cart page.
{
    ...
    if ($deliveryMode == "Normal Delivery") {
        $_SESSION["ShipCharge"] = 5.00; // Change the value accordingly
    } elseif ($deliveryMode == "Express Delivery") {
        $_SESSION["ShipCharge"] = 10.00; // Change the value accordingly
    } else {
        $_SESSION["ShipCharge"] = 0.00; // Default or handle invalid cases
    }
